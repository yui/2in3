YUI.add('yui2-connectioncore', function(Y) { Y.use('yui2-connection'); }, '3.2.0' ,{"requires": ["yui2-yahoo", "yui2-event"]});
...
YAHOO.register("connection", YAHOO.util.Connect, {version: "2.8.2r1", build: "8"});
