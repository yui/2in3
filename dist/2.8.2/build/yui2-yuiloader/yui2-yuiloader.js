YUI.add('yui2-yahoo', function(Y) { Y.use('yui2-yuiloader'); }, '3.2.0' ,{});
YUI.add('yui2-get', function(Y) { Y.use('yui2-yuiloader'); }, '3.2.0' ,{"requires": ["yui2-yahoo"]});
...
YAHOO.register("get", YAHOO.util.Get, {version: "2.8.2r1", build: "8"});
/**
...
YAHOO.register("yuiloader", YAHOO.util.YUILoader, {version: "2.8.2r1", build: "8"});
