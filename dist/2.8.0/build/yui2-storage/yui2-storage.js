...
var Y = YAHOO.util,
	...
	YAHOO.register("StorageManager", Y.SWFStore, {version: "2.8.0r4", build: "2446"});
}());
(function() {
...
YAHOO.register("storage", YAHOO.util.Storage, {version: "2.8.0r4", build: "2446"});

}, '2.8.0' ,{"requires": ["yui2-yahoo", "yui2-event", "yui2-cookie"], "optional": ["yui2-dom", "yui2-element", "yui2-swf", "yui2-swfstore"]});
