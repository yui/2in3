...
YAHOO.register("event-mouseenter", YAHOO.util.Event, {version: "2.9.0pr1", build: "2725"});
...
YAHOO.register("selector", YAHOO.util.Selector, {version: "2.9.0pr1", build: "2725"});
...
YAHOO.register("datatable", YAHOO.widget.DataTable, {version: "2.9.0pr1", build: "2725"});

}, '2.9.0pr1.2725' ,{"requires": ["yui2-yahoo", "yui2-dom", "yui2-event", "yui2-skin-sam-datatable", "yui2-element", "yui2-datasource"], "optional": ["yui2-skin-sam-paginator", "yui2-paginator", "yui2-dragdrop", "yui2-skin-sam-calendar", "yui2-calendar"]});
